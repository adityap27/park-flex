...
const AccountCard = () => {
  ...
  return (
    <>
    <div className=" bg-white rounded-2xl border w-full md:w-96 h-96  md:ml-auto md:mr-20 my-20 overflow-hidden transition-transform transform hover:scale-105 ">
      <div className="px-4 py-2 flex flex-col md:flex-row md:items-center">
        <h1 className="text-2xl font-semibold text-blue-700  md:mb-0 md:mr-4">
          My Wallet
        </h1>
      ...
      <div className="flex flex-col items-center p-4 mt-4">
        ...
        <div className="flex flex-wrap justify-center gap-1">
          <button
            ...
            className="bg-white border border-blue-700 text-blue-500 px-4 py-2 rounded-md hover:bg-blue-700 hover:text-white transition-transform transform hover:scale-105 mb-2"
         >
            + $50.00
          </button>
          <button
            onClick={() => handleAddMoneyButton("100.00")}
            className="bg-white border border-blue-500 text-blue-500 px-4 py-2 rounded-md hover:bg-blue-500 hover:text-white transition-transform transform hover:scale-105 mb-2"
          >
            + $100.00
          </button>
          <button
      ...
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-blue-700 rounded-b-2xl flex items-center justify-between p-4">
